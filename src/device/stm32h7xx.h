/**
  ...
  *
  *          Minimal header for jOS RTOS port — dispatches to the H750 variant
  *          header based on the STM32H750xx preprocessor define.
  ******************************************************************************
  */
...
#error "Please select the target STM32H7xx device: define STM32H750xx in compiler preprocessor"
#endif
