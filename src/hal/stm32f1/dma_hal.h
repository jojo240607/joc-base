...
/*
 * Minimal dma_hal.h stub for STM32F103.
 *
 * The F1 minimal port skips DMA entirely (all UART I/O uses IRQ mode).
 ...
 * implementations — since no F103 board node instantiates DMA, the code
