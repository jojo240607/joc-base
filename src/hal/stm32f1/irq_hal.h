...
/*
 * STM32F1 implementation of the interrupt HAL.
 *
 ...
 *
 * F103 has 43 external device IRQs (WWDG..DAC) plus 16 core exception slots
 * for a total of 16 + 43 = 59.
 */

#define IRQ_HAL_TABLE_SIZE  (16 + 43)
