 ...
 *   - Peripheral signals come from the AF database in pinmux_af_stm32f4.c,
 *     where EVERY name is UNIQUE (duplicate signals carry a "_P<port><pin>"
 *     suffix, e.g. "USART1_TX_PA9" vs "USART1_TX_PB6"), so the name maps to
 *     exactly one pad — no "first match wins" ambiguity.
